...
export const metadata: Metadata = {
  ...
  description:
    "Mood board preview for homepage hero component on mobile screens",
};
    ...
    <main className="min-h-screen bg-canvas">
      ...
      <section className="container mx-auto px-6 py-8 border-b border-border-light">
        <div className="max-w-3xl">
          <h2 className="text-h5 font-semibold text-black mb-3">
            Design Intent
          </h2>
          <p className="text-body text-text-secondary mb-4">
            This hero component follows the brand voice guidelines: dry but
            genuine, technical but accessible, conversational professional.
            Three variants explore different approaches to the opening message.
          </p>
          <div className="grid gap-3 text-body-sm text-text-secondary">
            <div>
              <span className="font-semibold text-black">Variant 1:</span> Direct
              introduction with personality
            </div>
            <div>
              <span className="font-semibold text-black">Variant 2:</span>{" "}
              Problem-solver focus
            </div>
            <div>
              <span className="font-semibold text-black">Variant 3:</span>{" "}
              Understated expert (recommended)
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-12">
        <h2 className="text-h4 font-bold text-black mb-6">
        ...
        <div className="max-w-2xl space-y-6">
          <div>
            ...
            <p className="text-body text-text-secondary">
              All variants use generous spacing between headline, subtext, and
              CTA. This ensures comfortable reading on small screens without
              feeling cramped.
            </p>
          </div>
          <div>
            ...
            <p className="text-body text-text-secondary">
              Headlines use <code className="text-code font-mono">text-h1</code>{" "}
              (3rem/48px) with tight line-height. Body text uses{" "}
              <code className="text-code font-mono">text-body-lg</code>{" "}
              (1.125rem/18px) for comfortable reading.
            </p>
          </div>
          <div>
            <h3 className="text-h6 font-semibold text-black mb-2">
          ...
          <div>
            ...
            <p className="text-body text-text-secondary mb-3">
              All variants avoid hype language and performative enthusiasm.
              They&apos;re conversational professional—like talking with a
              knowledgeable colleague over coffee.
            </p>
            <div className="bg-surface border border-border-light rounded-lg p-4 space-y-2">
              <p className="text-body-sm text-text-primary">
                <span className="font-semibold">✅ Good:</span> &quot;15+ years
                shipping&quot; (concrete, specific)
              </p>
              <p className="text-body-sm text-text-primary">
                <span className="font-semibold">❌ Avoid:</span>{" "}
                &quot;Passionate about ML&quot; (performative)
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-6 py-12 border-t border-border-light">
        <div className="max-w-2xl">
          ...
          <ul className="space-y-3 text-body text-text-secondary">
            <li>
              1. <span className="font-semibold text-black">Review</span> the
              three variants on actual mobile devices
            </li>
            <li>
              2. <span className="font-semibold text-black">Choose</span> the
              variant that best captures your voice
            </li>
            <li>
              3. <span className="font-semibold text-black">Iterate</span> on
              copy if needed (mix and match elements)
            </li>
            <li>
              4. <span className="font-semibold text-black">Finalize</span>{" "}
              accent style (line, dots, or minimal)
            </li>
            <li>
              5. <span className="font-semibold text-black">Implement</span> on
              actual homepage
            </li>
          </ul>
        </div>
