...
export function GitHubButton({ text, url, className }: GitHubButtonProps) {
  return (
    <a
      href={url}
      target="_blank"
    ...
    >
      <svg className="w-6 h-6 group-hover:text-brand transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path
          fillRule="evenodd"
