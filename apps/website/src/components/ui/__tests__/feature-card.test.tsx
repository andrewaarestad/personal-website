...
describe("FeatureCard", () => {
  describe("Background variants", () => {
    ...
    it("renders gradient-primary variant with correct classes", () => {
      render(
        <FeatureCard background="gradient-primary" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders gradient-reverse variant with correct classes", () => {
      render(
        <FeatureCard background="gradient-reverse" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders gradient-subtle variant with correct classes", () => {
      render(
        <FeatureCard background="gradient-subtle" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders surface background variant", () => {
      render(
        <FeatureCard background="surface" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders canvas background variant", () => {
      render(
        <FeatureCard background="canvas" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
  ...
  describe("Border variants", () => {
    ...
    it("renders no border with none variant", () => {
      render(
        <FeatureCard border="none" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders light border variant", () => {
      render(
        <FeatureCard border="light" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders brand border with hover state", () => {
      render(
        <FeatureCard border="brand" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders info border with hover state", () => {
      render(
        <FeatureCard border="info" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders highlight border with hover state", () => {
      render(
        <FeatureCard border="highlight" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
  ...
  describe("Padding variants", () => {
    ...
    it("renders compact padding variant", () => {
      render(
        <FeatureCard padding="compact" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders default padding variant", () => {
      render(
        <FeatureCard padding="default" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("renders spacious padding variant", () => {
      render(
        <FeatureCard padding="spacious" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
  ...
  describe("Combining variants", () => {
    it("combines background, border, and padding variants", () => {
      render(
        <FeatureCard background="surface" border="info" padding="compact" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
    ...
    it("accepts and merges custom className", () => {
      render(
        <FeatureCard className="custom-class" data-testid="card">
          Content
        </FeatureCard>
      );
      const card = screen.getByTestId("card");
