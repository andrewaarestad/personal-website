...
const featureCardVariants = cva("rounded-xl transition-colors", {
  variants: {
    background: {
      "gradient-primary":
        "bg-gradient-to-br from-brand-light/30 via-brand-secondary-light/30 to-highlight-light/30",
      "gradient-reverse":
        "bg-gradient-to-br from-brand-secondary-light/30 via-highlight-light/30 to-brand-light/30",
      "gradient-subtle":
        "bg-gradient-to-br from-gradient-brand-subtle via-canvas to-gradient-brand-secondary-subtle",
      surface: "bg-surface",
      canvas: "bg-canvas",
    },
    border: {
