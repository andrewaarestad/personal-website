  ...
  return (
    <footer className="w-full border-t border-border-light bg-card/50 backdrop-blur-sm">
      <div className="container mx-auto px-6 py-10 max-w-5xl">
        {/* Top section: Photo + name + social links */}
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-8">
          <Image
            src="/img/andrew_head.jpg"
            alt="Andrew Aarestad"
            width={80}
            height={80}
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-body-lg font-semibold text-foreground mb-3">Andrew Aarestad</h3>
            <div className="flex items-center gap-4">
              ...
              <Link
                href="https://www.linkedin.com/in/andrewaarestad/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-text-tertiary hover:text-foreground transition-colors"
                aria-label="LinkedIn"
              ...
              <Link
                href="https://medium.com/@andrew.aarestad"
                target="_blank"
                rel="noopener noreferrer"
                className="text-text-tertiary hover:text-foreground transition-colors"
                aria-label="Medium"
              ...
              <Link
                href="mailto:andrew@hypercolordigital.com"
                className="text-text-tertiary hover:text-foreground transition-colors"
                aria-label="Email"
              >
