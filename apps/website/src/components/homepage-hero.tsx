...
export function HomepageHero({ variant = "direct", showAccent = true }: HomepageHeroProps) {
  return (
      ...
      <div className="container mx-auto px-6 py-16 max-w-2xl">
        ...
        {variant === "direct" && (
          <div className="space-y-8">
            {showAccent && <div className="w-12 h-1 bg-brand" aria-hidden="true" />}
            <div>
              <h1 className="text-h1 font-extrabold text-foreground mb-4">Hi, I&apos;m Andrew.</h1>
        ...
        {variant === "understated" && (
          <div className="space-y-8">
            {showAccent && <div className="w-16 h-0.5 bg-highlight" aria-hidden="true" />}
            <div>
              ...
              <p className="text-body-lg text-text-secondary max-w-xl">
                I work at the intersection of research and product—building everything from
                firmware-level signal processing to cloud-scale ML pipelines.
              </p>
            </div>
            <Button variant="brand" asChild>
